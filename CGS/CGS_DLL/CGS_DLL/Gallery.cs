...
namespace CGS_DLL
{
    public class Gallery
    {
        ...
        public string addArtPiece(string artpieceId, string curatorId, string artistID,
            string title, int year, double value, string status)
        {
            string message = null;
        ...
        public string saveCuratorInfo()
        {
            string info = "";
            using (StreamWriter sw = new StreamWriter(@"C:\Users\gytim\source\repos\CGS\CGS_Windows\CGS_Windows\curator.txt"))
            {
                foreach(Curator cur in myCurators)
                {
        ...
        public string saveArtistInfo()
        {
            string message = "";
            try
            {
                using(StreamWriter sw = new StreamWriter(@"C:\Users\gytim\source\repos\CGS\CGS_Windows\CGS_Windows\artist.txt"))
                {
                    foreach(Artist art in myArtists)
                    {
                        sw.WriteLine(art.toString());
                    }
                }
            }
            catch(Exception ex)
        ...
        public string saveArtPieceInfo()
        {
            string message = "";
            try
            {
                using(StreamWriter sw = new StreamWriter(@"C:\Users\gytim\source\repos\CGS\CGS_Windows\CGS_Windows\artPiece.txt"))
                {
